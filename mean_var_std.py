...
def calculate(list):
    ...
    return {
        ...
        'variance': [var_rows, var_columns, ls.var()],
        'standard deviation': [std_rows, std_columns, ls.std()],
        'max': [max_rows, max_columns, ls.max()],
        'min': [min_rows, min_columns, ls.min()],
        'sum': [sum_rows, sum_columns, ls.sum()]
        }